...
class TrackerViewTests(TestCase):
    ...
    # The complex of the next test represents the same complexity of the view itself.
    # For this reason, never stop to refactor the view until the tests are passing. :)
    ...
    def test_tracker_view_post_method(self, mock_portfolio_asset_create, mock_asset_get, 
                                      mock_portfolio_goc, mock_custom_user_goc, mock_user_goc):
        ...
        self.assertEqual(mail.outbox[0].subject, 'Confirmation of Portfolio Creation')
